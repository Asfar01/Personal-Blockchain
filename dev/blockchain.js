...
function Blockchain() {
  ...
  this.createNewBlock(
    100,
    null,
    this.calculateHash(null, 100, this.transactions)
  );
}
...
Blockchain.prototype.chainIsValid = function (blockchain) {
  ...
  const correctHash =
    genesisBlock.hash === this.calculateHash(null, 100, this.transactions);
  const correctData = genesisBlock.transactions.length === 0;
  if (!correctNonce || !correctPrevHash || !correctHash || !correctData)
    validChain = false;
